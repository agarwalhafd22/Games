        ...
        submit3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(wordHangman.isEmpty()||timeOne.isEmpty()||timeTwo.isEmpty()||hintEditText.getVisibility()==View.VISIBLE&&hintEditText.getText().toString().isEmpty())
                    Toast.makeText(hangman.this, "Enter all fields", Toast.LENGTH_SHORT).show();
                else if(Integer.parseInt(timeTwo)>59)
                    Toast.makeText(hangman.this, "Enter correct duration", Toast.LENGTH_SHORT).show();
                else {
                    Intent intent = new Intent(hangman.this, hangmanGame.class);
